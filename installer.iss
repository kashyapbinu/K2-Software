...
[Run]
; No skipifsilent: the in-app updater runs this installer /SILENT and relies on
; this entry to relaunch K2 afterwards (core/updater.py launch_installer_and_quit).
