...
| Quantity | K2 | Reference | Source | Rel. err | Tol | Status |
|---|---|---|---|---|---|---|
| C_Lα(M=0.4) / C_Lα(M=0.2) | 1.026 | 0.9906 | AEDC-TR-70-100 | 3.59% | 8% | ✓ |
| C_Lα(M=0.6) / C_Lα(M=0.2) | 1.076 | 1.056 | AEDC-TR-70-100 | 1.91% | 8% | ✓ |
| C_Lα(M=0.8) / C_Lα(M=0.2) | 1.167 | 1.156 | AEDC-TR-70-100 | 0.93% | 8% | ✓ |
| C_Lα(M=0.9) / C_Lα(M=0.2) | 1.241 | 1.214 | AEDC-TR-70-100 | 2.24% | 8% | ✓ |
| C_Lα at M=0.2 (absolute) | 0.04338 | 0.0456 | AEDC-TR-70-100 | 4.88% | 10% | ✓ |
| C_Lα at M=0.6 (absolute) | 0.04669 | 0.04816 | AEDC-TR-70-100 | 3.06% | 10% | ✓ |
| C_Lα at M=0.9 (absolute) | 0.05382 | 0.05534 | AEDC-TR-70-100 | 2.75% | 10% | ✓ |
| C_D0 at M=0.2 (diagnostic) | 0.03097 | 0.02583 | AEDC-TR-70-100 | 19.92% | 10% | diag |
| C_D0 at M=0.5 (diagnostic) | 0.03457 | 0.02609 | AEDC-TR-70-100 | 32.49% | 10% | diag |
| C_D0 at M=0.9 (diagnostic) | 0.05163 | 0.02802 | AEDC-TR-70-100 | 84.25% | 10% | diag |
...
| Quantity | K2 | Reference | Source | Rel. err | Tol | Status |
|---|---|---|---|---|---|---|
| Cone surface Cp (M=2, 10°) | 0.09942 | 0.1045 | Taylor–Maccoll | 4.84% | 10% | ✓ |
...
| Normal force Cn (body axes) | 1.432 | 1.327 | SU2 | 7.88% | 10% | ✓ |
| Drag coefficient Cd (wind axes) | 0.4548 | 0.4046 | SU2 | 12.41% | 10% | diag |
...
| Quantity | K2 | Reference | Source | Rel. err | Tol | Status |
|---|---|---|---|---|---|---|
| dC_L/dα at M=0.5 | 0.0449 | 0.0458 | AEDC-TR-70-100 | 1.96% | 15% | ✓ |
| C_L at M=0.5, α=6° | 0.2686 | 0.2761 | AEDC-TR-70-100 | 2.74% | 20% | ✓ |
| dC_L/dα at M=0.6 | 0.04499 | 0.04816 | AEDC-TR-70-100 | 6.58% | 15% | ✓ |
| C_L at M=0.6, α=6° | 0.2693 | 0.2934 | AEDC-TR-70-100 | 8.23% | 20% | ✓ |
| dC_L/dα at M=0.7 | 0.04559 | 0.04977 | AEDC-TR-70-100 | 8.40% | 15% | ✓ |
| C_L at M=0.7, α=6° | 0.2731 | 0.3038 | AEDC-TR-70-100 | 10.10% | 20% | ✓ |
| dC_L/dα at M=0.8 | 0.04695 | 0.05273 | AEDC-TR-70-100 | 10.96% | 15% | ✓ |
